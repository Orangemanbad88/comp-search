...
import { SubjectProperty, CompResult } from '@/types/property';
import { formatCurrency } from '@/lib/utils';

// Cape May County city center coordinates
...
export default function SubjectMapContent({ subject, onLocationSelect, listings = [] }: SubjectMapContentProps) {
  ...
  function handleListingClick(listing: CompResult) {
    const lat = listing.lat || undefined;
    const lng = listing.lng || undefined;
            ...
            >
              <Popup>
                <div className="text-xs min-w-[160px]">
                  ...
                  <div className="font-bold text-emerald-600 mt-1">{formatCurrency(listing.salePrice)}</div>
