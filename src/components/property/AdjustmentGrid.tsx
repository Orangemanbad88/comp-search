      ...
      <div className="wood-grain px-6 py-4 border-b border-walnut-dark/50">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="font-display text-xl font-semibold text-cream">Price Adjustments</h2>
              <p className="text-xs text-cream/50">Adjust comparable prices to match subject property</p>
            </div>
          </div>
          {hasMore && (
