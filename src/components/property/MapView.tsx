...
const MapContent = dynamic(() => import('./MapContent'), {
  ssr: false,
  loading: () => (
    <div className="h-80 bg-cream-dark dark:bg-[#111118] rounded-xl flex items-center justify-center border border-walnut/10 dark:border-gold/10">
    ...
    <div className="card-premium rounded-xl overflow-hidden">
      <div className="px-6 py-4 border-b border-walnut/10 dark:border-gold/10 flex items-center justify-between bg-gradient-to-r from-cream to-ivory dark:from-[#111118] dark:to-[#1a1a24]">
        ...
        <div className="flex items-center gap-4 text-xs">
          ...
          <div className="flex items-center gap-1.5">
            <div className="w-2.5 h-2.5 bg-walnut/40 dark:bg-cream/40 rounded-full"></div>
            <span className="text-walnut dark:text-cream/60">Available</span>
          </div>
        </div>
      </div>

      <div className="p-4 bg-gradient-to-b from-ivory to-cream dark:from-[#1a1a24] dark:to-[#111118]">
        <MapContent
          subject={subject}
          comps={comps}
